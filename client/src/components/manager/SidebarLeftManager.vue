...
export default defineComponent({
  ...
  setup(props) {
    ...
    const linkPrivate = [
      ["mdi-equal-box", "Dashboard", "/manager/dashboard"],
      ["mdi-table", "Quản lý danh mục", "/manager/category"],
      ["mdi-note-edit", "Quản lý bài viết", "/manager/post"],
    ];

    const linkPublic = [["mdi-note-edit", "Quản lý bài viết", "/manager/post"]];
